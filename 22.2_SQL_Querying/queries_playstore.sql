...
SELECT appname, reviews FROM analytics ORDER BY reviews DESC LIMIT 5;
...
SELECT * FROM analytics WHERE price BETWEEN 0.10 AND 1.0 ORDER BY reviews DESC LIMIT 10;
