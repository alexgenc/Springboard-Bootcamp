...
const doubleAndReturnArgs = (Arr1, ...args) => [...Arr1, ...args.map(val => val * 2)];
...
1)Remove a random element in the items array and return a new array without that item.
...
3)Return a new object with all the keys and values from obj and a new key/value pair 
